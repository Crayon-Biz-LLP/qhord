...
import { X, Mail, Lock, User, ArrowRight, Zap, ChevronRight, Activity, Globe, Database, Filter, ChevronLeft } from "lucide-react";
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <div className="space-y-2 md:space-y-4">
                    {isLogin ? (
                      <>
                        <UnderlineInput label="Email ID*" placeholder="Enter your email" type="email" />
                        <UnderlineInput label="Password*" placeholder="Enter your password" type="password" />
                      </>
                    ) : (
                      <>
                        <UnderlineInput label="Name*" placeholder="Full Name" />
                        <UnderlineInput label="Email ID*" placeholder="Email Address" type="email" />
                        <UnderlineInput label="Secret Key*" placeholder="Create Password" type="password" />
                      </>
                    )}
                  </div>
                  ...
                  <div className="pt-1 md:pt-2 space-y-4 md:space-y-6">
                    <motion.button
                      ...
                      className="w-full group py-3 md:py-3.5 bg-[#1a1510] text-white rounded-xl font-black text-[9px] md:text-[10px] uppercase tracking-[0.4em] md:tracking-[0.5em] shadow-xl relative overflow-hidden flex items-center justify-center gap-2 md:gap-3"
                    >
                    ...
                    <div className="px-0 md:px-2">
                       ...
                       >
                         ...
                         <span className="text-xs md:text-sm font-bold tracking-tight">Sign up with Google</span>
                       </button>
                    </div>
                  </div>
                </motion.div>
