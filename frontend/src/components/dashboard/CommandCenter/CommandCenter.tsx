                     ...
                     <div className="bg-[#f7f8f9] p-2 rounded-2xl border border-[#1a1510]/5 flex items-center gap-1 shrink-0">
                        {(["Manual", "Assisted", "Autopilot"] as const).map((mode) => (
                           <button
                              ...
                              className={`px-6 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-[0.2em] transition-all ${operatorMode === mode
                     ...
                     <div className="flex-1 overflow-y-auto pr-2 space-y-8 relative">
                        ...
                        {DASHBOARD_DATA.liveActivity.concat([
                           ...
                           <div key={i} className="flex gap-6 relative group z-10">
                              <div className={`w-6 h-6 rounded-full flex items-center justify-center border border-white shadow-md z-20 shrink-0 ${ev.type === 'error' ? 'bg-red-500 text-white' : ev.type === 'success' ? 'bg-emerald-500 text-white' : 'bg-[#1a1510] text-brand-gold'
                                 }`}>
                                 <ev.icon size={12} />
                              </div>
                              <div className="flex-1">
                              ...
                              {DASHBOARD_DATA.healthTable.map((row, i) => (
                                 <tr key={i} className="hover:bg-[#f7f8f9] transition-colors group cursor-pointer">
                                    ...
                                    <td className="py-6 px-4 text-center">
                                       <span className={`text-[8px] font-black px-2.5 py-1 rounded-full uppercase tracking-wider ${row.status === 'Active' ? 'bg-emerald-500/10 text-emerald-600' :
