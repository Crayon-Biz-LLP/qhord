      ...
      <main className="flex-1 overflow-y-auto p-8 lg:p-12 space-y-10 scrollbar-hide pb-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
           {[
              ...
              { label: "Total Meetings", val: dashboardMetrics?.totalMeetings || "0", color: "text-blue-500", icon: MessageSquare },
              { label: "Total Emails", val: dashboardMetrics?.totalEmails || "0", color: "text-brand-gold", icon: Target },
