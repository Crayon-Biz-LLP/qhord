              ...
              >
                 ...
                 <div className="px-5 sm:px-8 py-5 sm:py-6 border-b border-[#1a1510]/5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    ...
                    <div className="flex gap-2 w-full sm:w-auto justify-end">
                       ...
                       <button className="flex-1 sm:flex-none h-10 px-5 rounded-xl bg-[#1a1510] text-brand-gold text-[9px] font-black uppercase tracking-widest shadow-lg">
                          Manage Hub
                       </button>
                    </div>
                 </div>
                 ...
                 <div className="p-5 sm:p-8 space-y-6">
                    ...
                    <div className="pt-6 border-t border-[#1a1510]/5 space-y-4">
                       ...
                       <div className="flex flex-wrap gap-2">
                          ...
                          <button className="flex-1 sm:flex-none h-10 px-5 rounded-xl border border-[#1a1510]/10 text-[#1a1510] text-[9px] font-black uppercase tracking-widest flex items-center justify-center gap-2 whitespace-nowrap"><ExternalLink size={12} /> CRM Sync</button>
                       </div>
                    </div>
                 </div>
              </motion.div>
